...
public class AddServicesPreAuth extends ImisActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        alAdapter = new SimpleAdapter(AddServicesPreAuth.this,PreAuthorizationActivity.lvServiceList, R.layout.lvitem,
        ...
        if (isIntentReadonly()) {
                ...
                if (position >= 0) {
                    ...
                    if (!packageType.equals("S")) {
                        ...
                        try {
                            ...
                            ssAdapterServicesItems = new CustomAdapter(AddServicesPreAuth.this, editModelArrayListServices);
                            TextView textServices = new TextView(AddServicesPreAuth.this);
                            textServices.setText("Sub-Services & Items");
                            textServices.setPadding(0, 0, 0, 10);
                            textServices.setTextSize(18);
                            listServices = new ListView(AddServicesPreAuth.this);
            ...
            btnAdd.setOnClickListener(v -> {
                try {
                    ...
                    PreAuthorizationActivity.lvServiceList.add(lvService);
            ...
            lvServices.setOnItemLongClickListener((parent, view, position, id) -> {
                try {
                    ...
                    d.setOnClickListener(v -> {
                        PreAuthorizationActivity.lvServiceList.remove(Pos);
                        HideAllDeleteButtons();
                        alAdapter.notifyDataSetChanged();
                    });
                } catch (Exception e) {
