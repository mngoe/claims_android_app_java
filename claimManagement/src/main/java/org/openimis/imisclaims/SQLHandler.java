...
public class SQLHandler extends SQLiteOpenHelper {
    ...
    private static final String CreateTableServices = "CREATE TABLE IF NOT EXISTS tblServices(Id text, Code text, Name text, Type text, Price text, PackageType text, Program text);";
    private static final String CreateTableItems = "CREATE TABLE IF NOT EXISTS tblItems(Id text, Code text, Name text, Type text, Price text, Program text);";
    ...
    private static final String CreateTableMapping = "CREATE TABLE IF NOT EXISTS tblMapping(Code TEXT,Name TEXT,Type TEXT, Program TEXT, HFCode TEXT);";
    ...
    private static final String CreateTableClaimAdmins = "CREATE TABLE IF NOT EXISTS tblClaimAdmins(Id TEXT, Code TEXT, HFCode TEXT, HFId TEXT ,Name TEXT, CreatedAt TEXT, Programs TEXT);";
    ...
    private static final String createTableClaimDetails = "CREATE TABLE IF NOT EXISTS tblClaimDetails(ClaimUUID TEXT, ClaimDate TEXT, HFCode TEXT, ClaimAdmin TEXT, ClaimCode TEXT, GuaranteeNumber TEXT, InsureeNumber TEXT, StartDate TEXT, EndDate TEXT, Program TEXT, ICDCode TEXT, Comment TEXT, Total TEXT, ICDCode1 TEXT, ICDCode2 TEXT, ICDCode3 TEXT, ICDCode4 TEXT, VisitType TEXT, ClaimPrefix TEXT, TestNumber TEXT, Tdr TEXT);";
    ...
    public void InsertService(String Id, String Code, String Name, String Type, String Price, String PackageType, String Program) {
        try {
            ContentValues cv = new ContentValues();
            cv.put("Id", Id);
            cv.put("Code", Code);
    ...
    public void InsertItem(String Id, String Code, String Name, String Type, String Price, String Program) {
        try {
            ContentValues cv = new ContentValues();
            cv.put("Id", Id);
            cv.put("Code", Code);
    ...
    public void InsertClaimAdmins(String Id, String Code, String hfCode, String Name, String hfId, String createdAt, String programs) {
        try {
            ContentValues cv = new ContentValues();
            cv.put("Id", Id);
            cv.put("Code", Code);
    ...
    public JSONObject getClaim(String claimUUID) {
        JSONArray claimDetails = getQueryResultAsJsonArray("tblClaimDetails",
                new String[]{"ClaimUUID", "ClaimDate", "HFCode", "ClaimAdmin", "ClaimCode", "GuaranteeNumber", "InsureeNumber", "StartDate", "EndDate", "Program", "ICDCode", "Comment", "Total", "ICDCode1", "ICDCode2", "ICDCode3", "ICDCode4", "VisitType", "ClaimPrefix", "TestNumber", "Tdr"},
                "LOWER(ClaimUUID) = ?",
